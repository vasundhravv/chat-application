...
const client = algoliasearch("5aca7bf0f98c1713b6036c77715e8b8e", "37fdb395ceb509b78ac2d0f1fee7d0da"); /*use your own keys*/
const index = client.initIndex('chat-application');

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://chitchat-application-44f3a-default-rtdb.firebaseio.com/"
});
